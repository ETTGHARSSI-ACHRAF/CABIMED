...
const AddUser = () => {
  ...
  return (
    <>
    <button className="p-2 mr-2 border-sky-500 border text-sky-500 rounded transition duration-300 hover:bg-sky-500 hover:text-white focus:outline-none" onClick={()=>setOpen(true)}>Ajouter utilisateure</button>
    {open && 
    <div className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-25">
      ...
      <div className="w-full">
          <input type="email" placeholder="email" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
      </div>
      <div className="w-full">
          <input type="number" placeholder="salaire" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
      </div>
      <div className="w-full">
