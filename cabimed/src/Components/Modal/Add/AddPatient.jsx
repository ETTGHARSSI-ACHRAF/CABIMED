...
const AddPatient = () => {
    ...
    return (
        <>
            <button className="p-2 mr-2 border-sky-500 border text-sky-500 rounded transition duration-300 hover:bg-sky-500 hover:text-white focus:outline-none" onClick={() => setOpen(true)}>Ajouter Patient</button>
            {open &&
                        ...
                        <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg w-full max-h-full p-8">
                            ...
                            <div className="p-6 space-y-6">
                                <div className="flex w-full ">
                                    ...
                                    <div className=' mx-1'>
                                        <input type="text" placeholder="Prenom" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                </div>
                                <div className="flex w-full ">
                                    <div className='mx-1'>
                                        <input type="text" placeholder="sex" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                    <div className='mx-1'>
                                        <input type="text" placeholder="cin" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                </div>

                                <div className="w-full">
                                    <input type="date" placeholder="date Naissance" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                </div>
                                <div className="w-full">
                                    <input type="text" placeholder="Lieu Naissance" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                </div>
                                <div className="w-full">
                                    <input type="text" placeholder="adresse" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                </div>
                                <div className="w-full">
                                    <input type="text" placeholder="tele" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                </div>
                                <div className="flex w-full ">
                                    <div className='mx-1'>
                                        <input type="text" placeholder="profession" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                    <div className='mx-1 w-1/2'>
                                        <select name="" id="" className="px-4 py-2 bg-gray-50 w-full rounded-md" >
                                            <option disabled selected value="">Mutuelle</option>
                ...
                <input type="checkbox" class="form-checkbox h-5 w-5 text-sky-600" /><span class="ml-2 text-gray-700">Ajouter a la salle d'attente</span>
            </label>
                                </div>
