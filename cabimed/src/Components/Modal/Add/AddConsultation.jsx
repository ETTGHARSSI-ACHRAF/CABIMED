...
const AddConsultation = () => {
  ...
  return (
    <>
            <button className="p-2 mr-2 border-sky-500 border text-sky-500 rounded transition duration-300 hover:bg-sky-500 hover:text-white focus:outline-none" onClick={() => setOpen(true)}>Ajouter Consultation</button>
            {open &&
                        ...
                        <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg w-full max-h-full p-8">
                            ...
                            <div className="p-6 space-y-6">
                                <div className="flex w-full ">
                                    <div className='mx-1' >
                                        <input type="text" placeholder="Motif" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                    <div className=' mx-1'>
                                        <input type="number" placeholder="Honoraire" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                </div>
                                <div className="flex w-full ">
                                    <div className='mx-1'>
                                        <input type="text" placeholder="diagnostic" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                    <div className='mx-1'>
                                        <input type="text" placeholder="conclusion" className="px-4 py-2 bg-gray-50 w-full rounded-md" />
                                    </div>
                                </div>
